...
export const metadata: Metadata = {
  ...
  keywords: [
    "Hotshot insurance",
    "Hotshot Sting insurance",
    "Hotshot MX4 insurance",
    "hotshot truck insurance",
    "truck insurance",
    "Hotshot XXX insurance",
    "electric motorcycle insurance",
    "truck coverage",
    "Hotshot coverage",
    "high-performance truck insurance",
    "off-road truck insurance",
  ],
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Hotshot Insurance - Specialized E-Bike Coverage",
      },
    ],
  },
  twitter: {
